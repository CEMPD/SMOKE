...
setenv SMKINVEN_FORMULA     "EXH__PMC=EXH__PM10-EXH__PM2_5" # formula for computing emissions value
...
## Script settings
setenv SRCABBR         nonroad  # abbreviation for naming log files
...
setenv DEBUG_EXE            idb # debugger to use when DEBUGMODE = Y

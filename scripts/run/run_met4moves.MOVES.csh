...
setenv ASSIGNS_FILE $SMKROOT/assigns/ASSIGNS.MOVES.cmaq.cb05p25tx.us12-ga
...
setenv STDATE 2009091                # Starting date in Julian
setenv ENDATE 2009120                # Ending date in Julian 
...
setenv SMOKE_OUTFILE $METDAT/$METSCEN/SMOKE_${GRID}_${STDATE}-${ENDATE}.txt
setenv MOVES_OUTFILE $METDAT/$METSCEN/MOVES_${GRID}_${STDATE}-${ENDATE}.txt

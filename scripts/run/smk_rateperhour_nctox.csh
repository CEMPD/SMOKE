...
setenv USE_REF_SCC_YN       N   # Y disaggregate SCC8 activity to full SCC10
setenv EXCLUDE_REF_SCC_YN   N   # Y drop SCCs not found in SCCXREF input file
...
setenv RPH_MODE             Y          # Y process off-network vapor venting EFs
...
## Script settings
setenv SRCABBR              rateperhour # abbreviation for naming log files

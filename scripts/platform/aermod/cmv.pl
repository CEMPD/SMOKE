...
require '/work/EMIS/users/mroark/WO270.5/aermod/aermod_script_testing/aermod.subs';
require '/work/EMIS/users/mroark/WO270.5/aermod/aermod_script_testing/aermod_np.subs';

...
#      if ( $RUN_SMKREPORT == Y ) set anytmprep = Y
   ...
   while ( $n < $ndays )
	 ...
	 setenv PTMP_WED  $INTERMED/ptmp_${SUBSECT}_${CASE}_$wed_date.ncf
	 setenv PTMP_THU  $INTERMED/ptmp_${SUBSECT}_${CASE}_$thu_date.ncf
	 setenv PTMP_FRI  $INTERMED/ptmp_${SUBSECT}_${CASE}_$fri_date.ncf
...
switch ( $M_TYPE ) 
  ...
  case week:
     ...
     if ( $RUN_HOLIDAYS == Y && $BASE_YEAR == 2022 ) set mrg_expected = 101
  ...
  case mwdss:
     ...
     if ( $RUN_HOLIDAYS == Y && $BASE_YEAR == 2022 ) set mrg_expected = 65

	...
	set todaylabel = "created on $todaysdate "
	 ...
	 if ( $sector_mrgg[$seccnt] == N ) goto end_of_sectorloop
	    ...
	    # performed when sectorcase == none.
		  ...
		  echo "nccopy -k classic $sector_orig_nc4[$seccnt] $sector_file[$seccnt]"
      ...
      if ($?NC4_OUTPUT) then
        if ($NC4_OUTPUT == Y) then
	  setenv OUTFILE    $OUTPUT/merged_${BEISLABEL}/emis_${MM}_all_${ESDATE}_${GRID}_${BEISLABEL}_${CASE}.nc4
	endif
      endif

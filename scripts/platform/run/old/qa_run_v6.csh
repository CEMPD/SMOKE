...
if ( $qa_type != custom ) then
   ...
   setenv REPORT10  $outdir/rep_${label}_${qa_type}_plant_scc.txt
   setenv REPORT14  $outdir/rep_${label}_${qa_type}_scc_srgid.txt
   setenv REPORT14B $outdir/rep_${label}_${qa_type}_state_scc_srgid_${GRID}.txt
   setenv REPORT15  $outdir/rep_${label}_${qa_type}_state_pm25prof.txt
   ...
   setenv REPORT20  $outdir/rep_${label}_${qa_type}_plant_oris.txt
   ...
   if ( $SMK_SOURCE == P ) then
      ...
      setenv REPORT10 $outdir/rep_${label}_${qa_type}_plant_scc.txt
      setenv REPORT11 $outdir/rep_${label}_${qa_type}_plant_cell_${GRID}.txt
      setenv REPORT12 $outdir/rep_${label}_${qa_type}_stackparm.txt
      setenv REPORT13 $outdir/rep_${label}_${qa_type}_plant.txt

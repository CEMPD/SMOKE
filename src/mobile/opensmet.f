        ...
        SUBROUTINE OPENSMET( ENAME, SDATE, STIME, TVARNAME, FNAME )
...
C...........   Other local variables
        ...
        CHARACTER*16 :: PROGNAME = 'OPENSMET' ! program name

C***********************************************************************
C   begin body of subroutine OPENSMET
...
C.........  Prompt for Source-based Output file
        FNAME = PROMPTMFILE(
     &          'Enter logical name for MIN/MAX TEMPERATURE file',

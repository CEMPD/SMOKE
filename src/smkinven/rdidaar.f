        ...
        SUBROUTINE RDIDAAR( FDEV, NRAWIN, NRAWBV, WKSET,
...
C...........   Local parameters, indpendent
        INTEGER, PARAMETER :: MXVARFIL = 63  ! maximum pollutants in file
...
C...........   Local parameters, dependent
        INTEGER, PARAMETER :: LINSIZ  = ARNONPWD + MXVARFIL * AROTWIDE
...
C.................  Initialize fixed-format field positions
                 ...
                 SEGMENT( 3 ) = ADJUSTL( LINE( 6:15 ) )  ! SCC
...
C........................  If reading emissions data (fixed) and annual data
C                          is zero (VANN=0) but ozone-season data is not 

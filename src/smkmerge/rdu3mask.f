        ...
        SUBROUTINE RDU3MASK( FNAME, JDATE, JTIME, NDIM, NVLIST, VNAMES,
     &                       VINDX, OUTVAR )
...
C.........  Other local variables
        ...
        INTEGER         LASTJ             !  counters and indices

        CHARACTER*16            VBUF    !  variable name buffer
        CHARACTER*300           MESG    !  message buffer

        CHARACTER*16 :: PROGNAME = 'RDU3MASK' ! program name

C***********************************************************************
C   begin body of subroutine RDU3MASK
...
C.............  Check variable index to see if this variable is to be read
            J = VINDX( V ) 
            IF( J .EQ. 0 .OR. LASTJ .EQ. J) CYCLE  ! to go bottom of loop
